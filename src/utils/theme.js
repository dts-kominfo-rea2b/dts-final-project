...
export const FeatureTitle =
  'w-full text-14px font-semibold text-gray-900 mt-0 mb-2';

export const FeatureDetails = 'w-full leading-6 text-12px';

// ---------------
// Call To Action
// ---------------
export const CTABase =
  'w-full flex flex-col items-start px-[30px] py-45px bg-cover bg-center bg-no-repeat bg-gray-100 border-0 border-gray-300 rounded overflow-hidden relative xxl:py-60px xxl:px-80px';
...
export const SearchInput =
  'w-full h-10 lg:h-12 pl-12 px-4 text-gray-900 placeholder-gray-500 bg-gray-f7 border-2 border-transparent rounded outline-none transition duration-200 hover:border-gray-400 focus:border-black focus:placeholder-gray-900';
...
// Carousel
// ---------
export const ButtonGroupBase = 'flex items-center absolute top-[50%] w-full';
