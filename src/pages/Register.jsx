...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    register(auth, email, password, dispatch, navigate);
  };
  ...
  return (
    <div className='w-96 flex flex-col justify-center mx-auto'>
      <div className='mb-6'>
        <h3 className='font-semibold text-2xl text-white-800'>Register </h3>
        <p className='text-white-500'>
          Please register your account to access this site.
        </p>
      </div>
